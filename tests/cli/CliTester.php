<?php //[STAMP] 9fa7879ca8206944372e26140ec0a83a
...
class CliTester extends \Codeception\Actor
{
    ...
    {
        return $this->scenario->runStep(
            new \Codeception\Step\ConditionalAssertion('seeInShellOutput', func_get_args())
        );
    }
    ...
    {
        return $this->scenario->runStep(
            new \Codeception\Step\ConditionalAssertion('dontSeeInShellOutput', func_get_args())
        );
    }
    ...
    {
        return $this->scenario->runStep(
            new \Codeception\Step\ConditionalAssertion('seeShellOutputMatches', func_get_args())
        );
    }
    ...
    {
        return $this->scenario->runStep(new \Codeception\Step\Action('runShellCmd', func_get_args()));
    }
}
